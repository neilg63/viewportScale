...
<dl>
	...
	<dt>detect:</dt><dd>Default = <strong>'strict'</strong>, unless only simplified string syntax is used in first parameter, in which case only a basic test is run. Use 'skip' to suppress browser detection altogether.</dd>
</dl>
